...
const Editor = ({
  ...
  useEffect(() => {
    ...
    import("jodit-react").then((module) => {
      ...
      module.Jodit.modules.Icon.set(
        "tooltip",
        '<img src="https://cdn0.iconfinder.com/data/icons/leading-international-corporate-website-app-collec/16/Info-512.png">'
      );
      module.Jodit.modules.Icon.set(
        "greenCheck",
        '<img src="https://img.icons8.com/?size=100&id=Zy5ghkQj2rKy&format=png&color=000000" />'
      );
      module.Jodit.modules.Icon.set(
        "math",
  ...
  const handleModelChange = (value) => {
    ...
    doc.querySelectorAll("img.Wirisformula").forEach((img) => {
      ...
      img.style.width = "auto"; // Keep original width
      img.style.height = "auto"; // Maintain aspect ratio
      img.style.resize = "none"; // Make it non-resizable
      img.style.maxWidth = "100%"; // Ensure it doesn't overflow its container
