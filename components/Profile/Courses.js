                ...
                <TableBody>
                    {items && items.map((item, itemIndex) =>
                        <TableRow
                            ...
                            className={`${item.enabled ? 'opacity-100' : 'opacity-5'}  flex flex-row justify-between w-full py-2 px-4 text-base font-normal ${!isOdd(itemIndex) ? 'bg-secondary' : 'bg-[#eef2f7]'}`}>
